...
| 分析状态 | completed |
| 分析时间 | 2026-06-11T08:48:56.497938+00:00 |
...
| 39 | ShowRecordSetByZone | hcloud DNS ShowRecordSetByZone | 效果完全一致 | - | 可接受 | local_cli |
| 40 | ShowRecordSetWithLine | hcloud DNS ShowRecordSetWithLine | 效果完全一致 | - | 可接受 | local_cli |
...
| 57 | ShowListener | hcloud Elb ShowListener/v2 | 效果完全一致 | - | 可接受 | local_cli |
...
| 61 | ShowPool | hcloud Elb ShowPool/v2 | 效果完全一致 | - | 可接受 | local_cli |
...
| 68 | ListPrivateDnats | hcloud Nat ListPrivateDnats | 效果完全一致 | - | 可接受 | local_cli |
| 69 | ListPrivateNats | hcloud Nat ListPrivateNats | 效果完全一致 | - | 可接受 | local_cli |
...
| 72 | ListPrivateSnats | hcloud Nat ListPrivateSnats | 效果完全一致 | - | 可接受 | local_cli |
...
| 84 | ShowPrivateDnat | hcloud Nat ShowPrivateDnat | 效果完全一致 | - | 可接受 | local_cli |
| 85 | ShowPrivateNat | hcloud Nat ShowPrivateNat | 效果完全一致 | - | 可接受 | local_cli |
| 86 | ShowPrivateNatTags | hcloud Nat ShowPrivateNatTags | 效果完全一致 | - | 可接受 | local_cli |
| 87 | ShowPrivateSnat | hcloud Nat ShowPrivateSnat | 效果完全一致 | - | 可接受 | local_cli |
